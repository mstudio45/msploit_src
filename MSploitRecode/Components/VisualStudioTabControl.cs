...
{
    public partial class VisualStudioTabControl : TabControl
    {
        /// <summary>
        ...
        [Category("Options"), Browsable(true), Description("button height size offset")]
        public int RecHeightOffset
        {
            get
            {
                return this.recHeightOffset;
            }

            set
            {
                this.recHeightOffset = value;
            }
        }
                ...
                for (var i = 0; i < this.TabCount; i++)
                {
                    ...
                    try
                    {
                        if (this.ShowClosingMessage)
                        {
                            ...
                            {
                                if (this != null && this.TabPages.Count > 0)
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (SelectedTab != null)
            {
                try
                {
                    if (this.backTabColor != null)
                        SelectedTab.BackColor = this.backTabColor;
                    else
                        SelectedTab.BackColor = Color.FromArgb(28, 28, 28);
                }
                catch
                {
                    // ignored
            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                var Header = new Rectangle(
                    ...
                    new Size(GetTabRect(i).Width, GetTabRect(i).Height + this.recHeightOffset));
